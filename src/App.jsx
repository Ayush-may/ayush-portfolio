    ...
    <>
      ...
      <div ref={containerRef} className='' >
        ...
        <div id='home' className='flex min-h-dvh p-3' >
          <div className="w-full bg-white shadow columns-1 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-5 cursor-default">
            ...
            <div className='bg-gray-800 text-white p-4 rounded-xl break-inside-avoid items-center gap-3 my-2' >
            ...
            <div className='bg-gray-800 text-white p-4 rounded-xl break-inside-avoid items-center gap-3 ' >
              <p className='font-bold' >Social Media</p>
              <div className='mt-2 inline-block hover:bg-gray-700 duration-200 p-2 rounded-xl' >
                <FaGithub size={30} />
              </div>
              <div className='mt-2 inline-block hover:bg-gray-700 duration-200 p-2 rounded-xl' >
                <FaLinkedin size={30} />
            ...
            <div className='mt-2 bg-gray-800 text-white p-4 rounded-xl flex flex-col items-center break-inside-avoid gap-3'>

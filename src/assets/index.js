export const projects = {
    ...
    UPIpay: {
        ...
        image: "https://placehold.co/200",
        description:
            `Developed a smart UPI-style transaction engine featuring a secure JWT-backed wallet system, a cron-driven scheduler for instant and recurring payments, and robust MongoDB structures supporting atomic balance updates, delivered with a responsive React-based UI for seamless payment control.`,
        stacks: [
            "MERN STACKS",
            "ShadCN UI",
            "RabbitMQ",
